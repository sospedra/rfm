...
const Newsletter: React.FC<{}> = () => {
  return (
    ...
    >
      <div data-style='full'>
        <div data-element='column' className='p-8 formkit-column sm:p-6'>
          <h1
            className='text-lg font-bold formkit-header'
            data-element='header'
          >
            Join the newsletter
          </h1>
        ...
        <div data-element='column' className='p-4 formkit-column sm:p-6'>
          <ul
          ...
          <div data-element='fields' className='seva-fields formkit-fields'>
            <div className='formkit-field'>
              <input
                className='font-light text-black border rounded formkit-input'
            ...
            <button
              data-element='submit'
              className='font-bold text-white bg-pink-600 rounded formkit-submit hover:bg-pink-700'
            >
              <div className='formkit-spinner' />
              <span>Subscribe</span>
            </button>
          </div>
          <div data-element='guarantee' className='text-sm formkit-guarantee'>
            <p>
              I won’t send you spam <b>never</b>.
            </p>
            <p>
